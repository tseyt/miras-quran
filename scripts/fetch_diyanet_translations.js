...
// Configuration
const TRANSLATION_ID = 77; // Diyanet İşleri Başkanlığı
const LANGUAGE = 'tr';
const AUTHOR = 'diyanet';
const OUTPUT_DIR = path.resolve('src/data/translations/tr/diyanet');
...
// Main function
const main = async () => {
    console.log(`Fetching Diyanet translations (resource ID ${TRANSLATION_ID})...`);
